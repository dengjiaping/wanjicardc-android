...
public class DataUtil {
	 ...
	 */
	public static String getJsonFromServer(String url, Context context,FProtocol.HttpMethod method,
										   IdentityHashMap<String,String> postParameters, String streamName, File file) throws JSONException {
