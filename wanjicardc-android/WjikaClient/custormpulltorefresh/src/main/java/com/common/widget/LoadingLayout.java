...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	protected final View customLayout;
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
		case PULL_FROM_END:
			LayoutInflater.from(context).inflate(R.layout.addmores, this);
			break;

		case PULL_FROM_START:
		default:
			LayoutInflater.from(context).inflate(R.layout.fpull_to_refresh_header_vertical, this);
			break;
		}
		mInnerLayout = (FrameLayout) findViewById(R.id.fl_inner);
		mHeaderText = (TextView) mInnerLayout.findViewById(R.id.pull_to_refresh_text);
		customLayout = mInnerLayout.findViewById(R.id.customLayout);
	...
	public final void hideAllViews() {
		...
		if (View.VISIBLE == customLayout.getVisibility() ) {
	...
	public final void showInvisibleViews() {
		...
		if (View.INVISIBLE == customLayout.getVisibility()) {
			customLayout.setVisibility(View.VISIBLE);
		}
