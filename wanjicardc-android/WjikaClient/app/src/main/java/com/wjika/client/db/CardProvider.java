...
public class CardProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.wjika.client.Cardprovider";
	...
	public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
		...
		switch (uriType) {
			case MATCHS:
				rowsDeleted = sqlDB.delete(CardTable.TABLE_NAME, selection,
						selectionArgs);
				break;
			case MATCH_ID:
				String id = uri.getLastPathSegment();
				if (TextUtils.isEmpty(selection)) {
					rowsDeleted = sqlDB.delete(CardTable.TABLE_NAME,
							CardTable.COLUMN_CARD_ID + "=" + id,
							null);
				} else {
					rowsDeleted = sqlDB.delete(CardTable.TABLE_NAME,
							CardTable.COLUMN_CARD_ID + "=" + id
	...
	public Uri insert(@NonNull Uri uri, ContentValues values) {
		...
		switch (uriType) {
			case MATCHS:
				id = sqlDB.insert(CardTable.TABLE_NAME, null, values);
				break;
			default:
				throw new IllegalArgumentException("Unknown URI: " + uri);
		}
	...
	public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		switch (uriType) {
			...
			case MATCH_ID:
				...
				queryBuilder.appendWhere(CardTable.COLUMN_CARD_ID + "="
	...
	public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs) {
		...
		switch (uriType) {
			case MATCHS:
				rowsUpdated = sqlDB.update(CardTable.TABLE_NAME,
						values,
						selection,
						selectionArgs);
				break;
	...
	private void checkColumns(String[] projection) {
		String[] available = {CardTable.COLUMN_CARD_ID};
		if (projection != null) {
