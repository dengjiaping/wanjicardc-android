 ...
 * 商家adapter
 */
public class StoreAdapter extends BaseAdapterNew<StoreEntity> {

	private Context context;
	private String latitude;
	private String longitude;

	public StoreAdapter(Context context, List<StoreEntity> mDatas) {
	...
	protected void setViewData(View convertView, int position) {
		...
		storeOutOf.setText(context.getString(R.string.store_list_out_of, String.valueOf(entity.getTotalSale())));
