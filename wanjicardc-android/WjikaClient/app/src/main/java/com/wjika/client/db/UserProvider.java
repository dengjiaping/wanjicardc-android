...
public class UserProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.wjika.client.Userprovider";
		...
		switch (uriType) {
			...
			case MATCH_ID:
				...
				if (TextUtils.isEmpty(selection)) {
					rowsDeleted = sqlDB.delete(UserTable.TABLE_NAME,
	...
	public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		switch (uriType) {
			...
			case MATCH_ID:
				...
				queryBuilder.appendWhere(UserTable.COLUMN_USER_ID + "=" + uri.getLastPathSegment());
				break;
			default:
				throw new IllegalArgumentException("Unknown URI: " + uri);
		}
